...
console.log(JSON.stringify(kdTree.tree))

const nearestOne = kdTree.findNearest(new Node(1, 2));
console.log('Visited:', kdTree._visited);
console.log(nearestOne.point)

const nearestTwo = kdTree.findNearest(new Node(6, 5));
console.log('Visited:', kdTree._visited);
console.log(nearestTwo.point)

const nearestThree = kdTree.findNearest(new Node(6, 7));
console.log('Visited:', kdTree._visited);
console.log(nearestThree.point)
