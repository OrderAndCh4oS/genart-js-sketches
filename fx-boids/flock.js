class FlockData {
    ...
    constructor(context, width, height, colours, altColour) {
    ...
    drawShape = (index) => [
        (boid) => {
            ...
            this._context.lineWidth = 15 * (this._scaleMod * 1.5);
            ...
            this._context.lineWidth = 7 * (this._scaleMod * 1.5);
        ...
        (boid, scale = 1) => {
            this._context.globalCompositeOperation = 'source-over';
            this._context.fillStyle = this._altColour;
            this._context.beginPath();
            this._context.arc(boid.position.x, boid.position.y, 4 * scale, 0, Math.PI * 2, true);
            this._context.fill();
            this._context.fillStyle = boid.colour;
            this._context.beginPath();
            this._context.arc(boid.position.x, boid.position.y, 3 * scale, 0, Math.PI * 2, true);
            this._context.fill();
        },
        (boid) => {
            this._context.globalCompositeOperation = 'source-over';
            this._context.lineCap = 'round';
            this._context.lineWidth = 28 * this._scaleMod;
            this._context.strokeStyle = this._altColour;
            this._context.beginPath();
            this._context.moveTo(boid.lastPosition.x, boid.lastPosition.y);
            this._context.lineTo(boid.position.x, boid.position.y);
            this._context.stroke();
            this._context.lineWidth = 20 * this._scaleMod;
            this._context.strokeStyle = boid.colour;
            this._context.beginPath();
            this._context.moveTo(boid.lastPosition.x, boid.lastPosition.y);
            this._context.lineTo(boid.position.x, boid.position.y);
        ...
        (boid, scale = 1) => {
            const r = scale === 1 ? 5 * scale : (fxrand() * 5) + 3 * scale;
    ...
    initScaleMod() {
        ...
        this._scaleMod = [1, 1.015, 1.025, 1.05, 1.075][roll];
    }
    ...
    initParams() {
        ...
        switch(roll) {
            case 0:
                this.setParams(32, 50, 5000, 1.5E-05, 1.0E-05, 7.5E-6);
                break;
            case 1:
                this.setParams(40, 500, 6000, 1.875E-6, 3.75E-5, 3.125E-5);
                break;
            case 2:
                this.setParams(22, 0, 3500, 0.0004, 0.000375, 0.0003);
                break;
            case 3:
                this.setParams(32, 50, 1500, 0.0003, 0.0002, 0.00015);
                break;
            case 4:
                this.setParams(40, 500, 750, 0.0003, 0.0006, 0.0004);
                break;
            case 5:
                this.setParams(22, 0, 5000, 0.00006, 0.00008, 0.00005);
                break;
            case 6:
                this.setParams(28, 50, 10000, 7.5E-6, 5.0E-6, 4.25E-6);
                break;
        }
    }
